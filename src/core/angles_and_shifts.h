...
public:
	...
	AnglesAndShifts();
	AnglesAndShifts(float wanted_euler_phi, float wanted_euler_theta, float wanted_euler_psi, float wanted_shift_x = 0.0f, float wanted_shift_y = 0.0f, float wanted_shift_z = 0.0f);	// constructor with size
...
//	~AnglesAndShifts();							// destructor
	...
	void Init(float wanted_euler_phi_in_degrees, float wanted_euler_theta_in_degrees, float wanted_euler_psi_in_degrees, float wanted_shift_x, float wanted_shift_y, float wanted_shift_z = 0.0f);
	...
	inline float ReturnShiftZ() {return shift_z;};
